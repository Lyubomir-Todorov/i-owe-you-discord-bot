...
const {
    ...
    RECURRING_WORKSHEET_ROW_OFFSET = "3",
    RECURRING_WORKSHEET_DISABLED_COLUMN = "A",
    RECURRING_WORKSHEET_DESCRIPTION_COLUMN = "B",
    RECURRING_WORKSHEET_AMOUNT_COLUMN = "C",
    RECURRING_WORKSHEET_PURCHASER_COLUMN = "D",
    RECURRING_WORKSHEET_CATEGORY_COLUMN = "E",
    RECURRING_WORKSHEET_FREQUENCY_COLUMN = "F",
    RECURRING_WORKSHEET_LAST_PURCHASED_COLUMN = "G",
